...
public class EpgParser {
    ...
    private static XmlData parseXmlData(File file) throws Exception {
        ...
        Map<String, List<Tv.Channel>> map = tv.getChannel().stream().collect(Collectors.groupingBy(c -> java.util.Objects.toString(c.getId(), "")));
