...
import com.duo.tv.api.Decoder;
import com.duo.tv.api.LiveApi;
import com.duo.tv.api.loader.BaseLoader;
import com.duo.tv.api.parser.LiveParser;
import com.duo.tv.bean.Channel;
import com.duo.tv.bean.Config;
import com.duo.tv.bean.Depot;
import com.duo.tv.bean.Group;
import com.duo.tv.bean.Keep;
import com.duo.tv.bean.Live;
import com.duo.tv.bean.Rule;
...
public class LiveConfig extends BaseConfig {
    ...
    private void initLive(Config config, JsonObject object) {
        ...
        getLives().forEach(live -> { Live db = items.get(live.getName()); if (db != null) live.sync(db); });
