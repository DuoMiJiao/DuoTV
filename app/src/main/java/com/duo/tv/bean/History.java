...
import com.duo.tv.impl.Diffable;
import com.duo.tv.utils.DbKeyUtil;   // 【新增】key 解析越界安全工具
...
public class History implements Diffable<History> {
    ...
    public String getSiteKey() {
        // 【修复·P1 崩溃】改用越界安全的解析（脏 key 不再抛 ArrayIndexOutOfBounds）
        return DbKeyUtil.part(getKey(), 0);
    }

    public String getVodId() {
        // 【修复·P1 崩溃】同上
        return DbKeyUtil.part(getKey(), 1);
    }
