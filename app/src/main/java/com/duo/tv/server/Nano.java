...
import com.duo.tv.server.process.Action;
import com.duo.tv.server.process.Cache;
import com.duo.tv.server.process.Local;
import com.duo.tv.server.process.Media;
import com.duo.tv.server.process.Parse;
import com.duo.tv.server.process.Proxy;
...
public class Nano extends NanoHTTPD {
    ...
    public Response serve(IHTTPSession session) {
        ...
        if (!isAuthorized(session)) return error(Response.Status.FORBIDDEN, "token required");
