...
import com.duo.tv.db.dao.ConfigDao;
import com.duo.tv.db.dao.DeviceDao;
import com.duo.tv.db.dao.HistoryDao;
import com.duo.tv.db.dao.KeepDao;
import com.duo.tv.db.dao.LiveDao;
import com.duo.tv.db.dao.SiteDao;
import com.duo.tv.db.dao.TrackDao;
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static void backup() {
        backup(new com.duo.tv.impl.Callback());
    }

    public static void backup(com.duo.tv.impl.Callback callback) {
        Task.execute(() -> {
    ...
    public static void restore(File file, com.duo.tv.impl.Callback callback) {
        Task.execute(() -> {
