...
import com.duo.tv.databinding.DialogInfoBinding;
...
public class InfoDialog {
    ...
    private void initEvent() {
        ...
        binding.download.setOnClickListener(v -> onDownload());
    }
    ...
    private void onDownload() {
        callback.onDownload(url, header);
        dialog.dismiss();
    }
    ...
    public interface Listener {
        ...
        void onDownload(String url, String header);
    }
}
