...
import com.duo.tv.databinding.DialogSiteBinding;
import com.duo.tv.impl.SiteCallback;
import com.duo.tv.ui.adapter.SiteAdapter;
...
public class SiteDialog implements SiteAdapter.OnClickListener {
    ...
    private void init(Activity activity) {
        ...
        binding.input.setBackgroundResource(R.drawable.shape_search_pill);
    }
    ...
    private void setRecyclerView() {
        ...
        binding.input.addTextChangedListener(new CustomTextListener() {
            @Override
