...
import com.duo.tv.databinding.FragmentSettingBinding;
...
import com.duo.tv.ui.activity.HomeActivity;
import com.duo.tv.ui.base.BaseFragment;
import com.duo.tv.ui.dialog.ConfigDialog;
import com.duo.tv.ui.dialog.HistoryDialog;
import com.duo.tv.ui.dialog.LiveDialog;
import com.duo.tv.ui.dialog.RestoreDialog;
...
public class SettingFragment extends BaseFragment implements ConfigCallback, SiteCallback, LiveCallback {
    ...
    protected void initView() {
        ...
        mBinding.themeText.setText(getResources().getStringArray(R.array.select_theme_mode)[Setting.getThemeMode()]);
    ...
    protected void initEvent() {
        mBinding.theme.setOnClickListener(this::setThemeMode);
    ...
    private void setThemeMode(View view) {
        int index = (Setting.getThemeMode() + 1) % 3;
        Setting.putThemeMode(index);
        mBinding.themeText.setText(getResources().getStringArray(R.array.select_theme_mode)[index]);
    }
