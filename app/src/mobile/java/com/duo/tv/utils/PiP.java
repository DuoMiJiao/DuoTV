...
import com.duo.tv.event.ActionEvent;
import com.duo.tv.receiver.ActionReceiver;
...
public class PiP {
    ...
    public void update(Activity activity, boolean play) {
        try {
            ...
            actions.add(buildRemoteAction(activity, com.duo.tv.R.drawable.ic_action_audio, R.string.exo_controls_hide, ActionEvent.AUDIO));
